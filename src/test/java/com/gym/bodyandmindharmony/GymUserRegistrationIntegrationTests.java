...
public class GymUserRegistrationIntegrationTests {
    ...
    private static final String AUTHENTICATION_URL = "/api/auth/register";
    ...
    void theOneWhereFirstNameIsNull() throws Exception {
        final var request = """
                ...
                """;
        mockMvc
                .perform(post(AUTHENTICATION_URL).contentType(MediaType.APPLICATION_JSON).content(request))
